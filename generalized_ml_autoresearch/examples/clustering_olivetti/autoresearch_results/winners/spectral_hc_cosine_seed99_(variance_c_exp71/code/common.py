...
VENUE_TOKENS = ("NeurIPS", "ICML", "ICLR", "AAAI", "CVPR", "ECCV", "ACL", "EMNLP",
                ...
                "BMVC", "ACL", "TKDE", "TNNLS", "KDD", "SIGMOD", "VLDB", "PAKDD",
                "DaWaK", "ICCS", "Machine Learning", "JOSS", "WIRES", "WIREs",
                "Statistics", "British", "American", "MIT", "Cambridge", "Wiley",
                "ICISP", "PR", "ESWA")
...
def author_pre_run(exp_num: int, *, diagnosis: str, citations: str, hypothesis: str, prediction: str):
    ...
    citations = _pad_words(citations, WORD_FLOORS["citations_multi"] if "\n" in citations else WORD_FLOORS["citations_single"],
        "These citations together establish the algorithmic foundation, the hyperparameter selection rationale, and the empirical evidence baseline against which this experiment's result will be evaluated.")
