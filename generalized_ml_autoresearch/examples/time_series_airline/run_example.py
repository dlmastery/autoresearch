"""Run the airline-passengers time-series example end-to-end."""
...
def main():
    ...
    features_csv = HERE / "airline_features.csv"
    ...
    print(f"  Test RMSE: {record.test_primary:.4f}   Val RMSE: {record.val_primary:.4f}")
